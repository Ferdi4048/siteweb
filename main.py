...
def main_page():
    ...
    # Our Approach Page
        ...
        st.markdown(
            ...
            "<li><strong>Principal Component Analysis (PCA): </strong>  Reduces complex data (sensor readings) into two main directions (Principal Components) that capture most of the differences.</li>"
